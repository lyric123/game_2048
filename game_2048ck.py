    ...
    while True:
        ...
        if key in ('h', 'j', 'k', 'l'):
            ...
            if moved:
                ...
                continue  # 無効な移動なら何もせず再描画

        # 移動後に Game Over かどうかチェック
